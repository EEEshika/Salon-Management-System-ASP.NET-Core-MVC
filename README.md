...
![Staff List](images/admin-dashboard-staff-list.png)

---

## Service Management

![Service List](images/admin-dashboard-service-list.png)
...
![Payment History](images/admin-dashboard-payment-history.png)
